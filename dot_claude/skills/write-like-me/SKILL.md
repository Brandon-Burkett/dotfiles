...
- "It's important to note", "It's worth noting", "delve", "robust", "seamless", "leverage", "streamline", "comprehensive", "furthermore"
- "This isn't just X, it's Y" constructions; rhetorical questions as transitions
- Exclamation marks, emoji, em-dash chains
...
Draft it, then reread once asking "what can I delete?" and "does this sound typed or generated?" — delete and roughen accordingly. When the audience or level of detail is genuinely unclear, ask one question instead of guessing long.
